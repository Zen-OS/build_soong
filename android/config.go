...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Zen.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.ZenConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Zen.Specific_camera_parameter_library)
}
